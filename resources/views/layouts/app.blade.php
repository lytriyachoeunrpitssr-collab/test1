...
<html lang="en">
  ...
  <head>
    ...
    <title>Blogapp - @yield("title","BlogApp")</title>
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="{{ asset("dict/assets/img/user1-128x128.jpg") }}"
                        alt="User Avatar"
      ...
      <footer class="app-footer">
        ...
        <!--begin::Copyright-->
        <strong>
          Copyright &copy; 2025 @php echo date('Y') !== "2025" . "-" . date('Y'); @endphp &nbsp;
          <a href="{{ config('app.url') }}" class="text-decoration-none"> {{ config('app.name') }}</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
